...
# $Header: /var/cvsroot/gentoo-x86/app-admin/syslog-ng/syslog-ng-3.6.2.ebuild,v 1.15 2015/05/28 20:01:41 mr_bones_ Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${MY_PV_MM}/syslog-ng-3.6-keep-timestamp-no.patch  # Fixed upstream after (at least) 3.6.3
	epatch_user
