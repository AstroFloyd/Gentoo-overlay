...
MY_P="${PN}-setup_${PV}"
DESCRIPTION="MIT App Inventor2 Setup package"
HOMEPAGE="http://www.appinventor.mit.edu/"
SRC_URI="http://commondatastorage.googleapis.com/appinventordownloads/${MY_P}.tar.gz"
...
src_install() {
	...
	doins -r appinventor/extras
	doins -r appinventor/from-Android-SDK
	exeinto "${APP_INSTALL_DIR}"/commands-for-Appinventor/
	doexe appinventor/commands-for-Appinventor/*
}
