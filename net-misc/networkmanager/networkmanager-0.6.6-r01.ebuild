# Taken from networkmanager-0.6.6.ebuild, changed by MvdS to add memory-leak patch
# (See: http://bugs.gentoo.org/show_bug.cgi?id=234945#c1)
...
src_unpack () {
	...
	# Fix up the memory leak (http://bugs.gentoo.org/show_bug.cgi?id=234945#c1)
	epatch "${FILESDIR}/${PN}-memoryleak_MvdS.patch"
}
